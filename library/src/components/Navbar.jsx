        ...
        <ul className='flex justify-between items-center p-3 max-w-6xl mx-auto'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    ...
                    <button onClick={handleSearch} className='text-white bg-primary px-3 py-1 rounded-2xl flex items-center gap-1 hidden md:block'>
            ...
            <li className='flex gap-3 items-center'>
                ...
                {/* profile image  */}
                <div className='w-11'>
                    <img src="https://cdn-icons-png.freepik.com/512/3135/3135715.png" alt="" className='w-full rounded-full' />
                </div>
